...
# Example
population = [30.55, 2.77, 39.21]
countries = ["afghanistan", "albania", "algeria"]
ind_alb = countries.index("albania") # 1
print(ind_alb)  # 1
print(population[ind_alb]) # 2.77
...
dict ={
    ...
    "capital": ["Brasilia", "Moscow", "New Delhi", "Beijing", "Preyoria"],
...
# Example
import pandas as pd
bric = pd.read_csv("D:/datascipython/DataScience/airtravel.csv")
print(bric)
